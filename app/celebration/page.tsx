...
export default function CelebrationPage() { return <main className="celebration-page" id="top">
  <section className="cp-hero"><nav><strong>BN / 10</strong><div><a href="#about">ABOUT</a><a href="#guests">GUESTS</a><a href="#rsvp">JOIN</a></div></nav><figure><Image src={assetPath("/celebration-10th.png")} alt="10周年を祝うバルーン装飾" fill priority sizes="100vw" /></figure><div className="cp-hero-copy"><p>THANK YOU FOR THE PAST 10 YEARS</p><h1>10<sup>th</sup><br /><i>ANNIVERSARY</i></h1><span>{event.date}</span></div><a className="cp-ticket" href="#rsvp">JOIN THE PARTY ↘</a></section>
