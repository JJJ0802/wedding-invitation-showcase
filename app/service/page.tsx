...
export default function ServicePage() {
  return <main className="service-page">
    <nav className="service-nav"><strong>EVENT PAGES</strong><div><a href="#works">EXAMPLES</a><a href="#plans">PLANS</a><a href="#flow">FLOW</a><a className="service-nav-cta" href="mailto:hello@example.com">相談する</a></div></nav>
    ...
    <section className="service-final"><p className="service-kicker">YOUR NEXT GATHERING</p><h2>次の集まりを、<br />楽しみに変える。</h2><a className="service-button" href="mailto:hello@example.com">まずは相談する ↗</a></section>
